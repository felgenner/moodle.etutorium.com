...
/// for demonstrative purposes and to show how the etutorium
/// iself has been upgraded.

/// For each upgrade block, the file etutorium/version.php
...
/// First example, some fields were added to the module on 20070400
    ...
    /// Define field course to be added to etutorium
    ...
    /// Define field intro to be added to etutorium
        $table = new XMLDBTable('etutorium');
    ...
    /// Define field introformat to be added to etutorium
        $table = new XMLDBTable('etutorium');
...
/// "01" in the last two digits of the version
    ...
    /// Define field timecreated to be added to etutorium
        $table = new XMLDBTable('etutorium');
    ...
    /// Define field timemodified to be added to etutorium
        $table = new XMLDBTable('etutorium');
    ...
    /// Define index course (not unique) to be added to etutorium
        $table = new XMLDBTable('etutorium');
