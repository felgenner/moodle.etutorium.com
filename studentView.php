...
/**
 * view webinars with minimum capability
    ...
    <table style="width: 100%;" class="admintable generaltable">
        ...
        <tr id="<?php echo $webinar->id; ?>">
            ...
            <td style="text-align: center;">
                ...
                echo $etutorium->id; ?>" target="_blank" id="link<?php echo $webinar->webinar_id; ?>"><?php
                echo (!$diff->invert) ? get_string('connect', 'etutorium') : get_string('get_archive', 'etutorium'); ?></a>
            </td>
        </tr><?php
            }
        } ?>
