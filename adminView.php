...
/**
 * admin view (can add, remove, search webinars, view details)
...
<div style="height:15px;">&nbsp;</div>
<div>
    <div id="viewsearch" style="text-align: center; cursor: pointer;" onclick="webinaredit.viewpanel()"><?php
    echo get_string('searchpanel', 'etutorium'); ?></div>
...
echo get_string('findwebinar', 'etutorium'); ?>" onclick="webinaredit.getallwebinarlist()"></div>
<div style="height:15px;">&nbsp;</div>
